                ...
                <div class="panel panel-visible m10" id="spy2">
                  <div class="panel-heading">
                    <div class="panel-title hidden-xs">
                      <span class="glyphicon glyphicon-tasks"></span>Факультеты
                    </div>
                  </div>
                  <div class="panel-body pn">
                    <form action="/editing_faculties" method="POST">
                      <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center">Ссылка на программу</th>
                            <th class="text-center">Ссылка на QB</th>
                        ...
                        <tbody>
                          <?php foreach (($faculties?:array()) as $faculties): ?>
                            <tr>
                                <td><a href="/editing_faculties/<?php echo $faculties['fac_id']; ?>"><?php echo $faculties['fac_name']; ?></a></td>
                                <td class="text-center"><?php echo $faculties['fac_adress']; ?></td>
                                <td class="text-left"><?php echo $faculties['fac_study_type']; ?></td>
                                <td class="w150 text-center"><?php echo $faculties['fac_price']; ?></td>
                                <td class="w150 text-center"><?php echo $faculties['fac_quota']; ?></td>
                                <td class="w150 text-center"><a href="<?php echo $faculties['fac_program_link']; ?>"><?php echo $faculties['fac_program_link']; ?></a></td>
                                <td class="w150 text-center"><a href="<?php echo $faculties['fac_QB_link']; ?>"><?php echo $faculties['fac_QB_link']; ?></a></td>
                                <td class="w150 text-center">
                                  <a href="/delete_faculties/<?php echo $faculties['fac_id']; ?>" class="btn btn-xs btn-danger button btn-primary art_btn">Удалить</a>
                                </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
                      ...
                      <div class="row">
                        <div class="col-md-12 text-right p20">
                          <a href="/add_faculties/" class="btn btn-xs btn-success button btn-primary art_btn">добавить факультет</a>
                        </div>
                      </div>
                    </form>
                  </div>
