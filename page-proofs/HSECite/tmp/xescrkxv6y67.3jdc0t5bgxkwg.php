                ...
                <div class="panel panel-visible m10" id="spy2">
                  <div class="panel-heading">
                    <div class="panel-title hidden-xs">
                      <span class="glyphicon glyphicon-tasks"></span>Кампусы</div>
                  </div>
                  <div class="panel-body pn">
                    <form action="/editing_faculties" method="POST">
                      <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php foreach (($campus?:array()) as $campus): ?>
                            <tr>
                                <td><a href="/editing_campus/<?php echo $campus['campus_id']; ?>"><?php echo $campus['campus_name']; ?></a></td>
                                <td class="w150 text-center"><a href="/delete_campus/<?php echo $campus['campus_id']; ?>" class="btn btn-xs btn-danger button btn-primary art_btn">Удалить</a></td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
                      </table>
                      ...
                      <div class="row">
                        <div class="col-md-12 text-right p20">
                          <a href="/add_campus/" class="btn btn-xs btn-success button btn-primary art_btn">добавить кампус</a>
                        </div>
                      </div>
                    </form>
                  </div>
