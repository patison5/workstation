	    ...
	    <div class="notifications__main">
  			...
  			<div class="panel">
  			  <div class="panel-body">
  			    <?php foreach (($organization?:array()) as $organization): ?>
                                          
              <!-- форма редактирования Факультета -->
              <div class="admin-form theme-primary">
                <form action="/editing_organization" method="POST" id="form-ui">
                  <!-- Basic Inputs -->
                  <div class="row">
                    <div class="col-md-8">
                      <div class="section">
                        <label for="title" class="field">
                          <input type="text" name="title" id="title" class="gui-input" value="<?php echo $organization['name']; ?>">
                        </label>

						<label for="link" class="field">
                          <input type="text" name="link" id="link" class="gui-input" value="<?php echo $organization['link']; ?>">
                        </label>

                        <label for="description" class="field">
                          <input type="text" name="description" id="description" class="gui-input" value="<?php echo $organization['description']; ?>">
                        </label>
                        <label for="id_group" class="field">
                          <input type="text" name="id_group" id="id_group" class="gui-input" value="<?php echo $organization['id_group']; ?>">
                        </label>

                        <input type="hidden" name="id" class="gui-input" value="<?php echo $organization['id']; ?>">
                      </div>
                      </div>
                    </div>
                  </div>
