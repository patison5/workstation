                ...
                <div class="panel panel-visible m10" id="spy2">
                  <div class="panel-heading">
                    <div class="panel-title hidden-xs">
                      <span class="glyphicon glyphicon-tasks"></span>Профессии</div>
                  </div>
                  <div class="panel-body pn">
                    <form action="/editing_faculties" method="POST">
                      <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php foreach (($professions?:array()) as $prof): ?>
                            <tr>
                                <td><a href="/edit_professions/<?php echo $prof['prof_id']; ?>"><?php echo $prof['prof_name']; ?></a></td>
                                <td class="w150 text-center"><a href="/delete_professions/<?php echo $prof['prof_id']; ?>" class="btn btn-xs btn-danger button btn-primary art_btn">Удалить</a></td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
                      </table>
                      <div class="row">
                        <div class="col-md-12 text-right p20">
                          <a href="/add_profession/" class="btn btn-xs btn-success button btn-primary art_btn">добавить профессию</a>
                        </div>
                      </div>
                    </form>
                  </div>
