                ...
                <div class="panel panel-visible m10" id="spy2">
                  <div class="panel-heading">
                    <div class="panel-title hidden-xs">
                      <span class="glyphicon glyphicon-tasks"></span>Предметы</div>
                  </div>
                  <div class="panel-body pn">
                    <form action="/editing_faculties" method="POST">
                      <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php foreach (($subjects?:array()) as $subjects): ?>
                            <tr>
                                <td><a href="/editing_subjects/<?php echo $subjects['sub_id']; ?>"><?php echo $subjects['sub_name']; ?></a></td>
                                <td class="w150 text-center"><a href="/delete_subjects/<?php echo $subjects['sub_id']; ?>" class="btn btn-xs btn-danger button btn-primary art_btn">Удалить</a></td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
                      </table>
                      <div class="row">
                        <div class="col-md-12 text-right p20">
                          <a href="/add_subject/" class="btn btn-xs btn-success button btn-primary art_btn">добавить предмет</a>
                        </div>
                      </div>
                    </form>
                  </div>
