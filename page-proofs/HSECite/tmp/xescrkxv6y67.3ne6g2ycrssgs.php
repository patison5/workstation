    ...
    <section id="content_wrapper">
	    <div class="notifications__main">
              ...
              <div class="admin-form theme-primary">
                <form action="/editing_subjects" method="POST" id="form-ui">
                  <!-- Basic Inputs -->
                  <div class="row">
                    <div class="col-md-8">
                      <div class="section">
                        <label for="title" class="field">
                          <input type="text" name="title" id="title" class="gui-input" value="<?php echo $subjects['sub_name']; ?>">
                        </label>
                        <input type="hidden" name="id" class="gui-input" value="<?php echo $subjects['sub_id']; ?>">
                      </div>
                    </div>
                  </div>
