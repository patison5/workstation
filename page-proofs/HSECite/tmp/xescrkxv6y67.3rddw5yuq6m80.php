                ...
                <div class="panel panel-visible m10" id="spy2">
                  <div class="panel-heading">
                    <div class="panel-title hidden-xs">
                      <span class="glyphicon glyphicon-tasks"></span>Группы факультетов</div>
                  </div>
                  <div class="panel-body pn">
                    <form action="/show_articles" method="POST">
                      <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php foreach (($faculties?:array()) as $facultie): ?>
                            <tr>
                                <td class="w50 text-center">
                                  <label class="option block mn">
                                    <input type="checkbox" name="checked" value="<?php echo $faculties['id']; ?>">
                                    <span class="checkbox mn"></span>
                                  </label>
                                </td>
                                <td><a href="/editing_faculties/<?php echo $faculties['faculties_id']; ?>"><?php echo $faculties['fac_name']; ?></a></td>
                                <td class="text-center"><a href="<?php echo $faculties['link']; ?>"><?php echo $faculties['link']; ?></a></td>
                                <td class="text-left"><?php echo $faculties['description']; ?></td>
                                <td class="w150 text-center"><?php echo $faculties['group_name']; ?></td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
                      </table>
